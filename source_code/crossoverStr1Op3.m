...
%           crossoverOperator3: Single point cross over operator which respects the number of segments
% Input:
...
function [crossedPopulation,fitnessChanged] = crossoverStr1Op3(population,fitness,pCross,maxAttempts)
