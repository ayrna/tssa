...
%           crossoverOperator1: Single point cross over operator with size restriction
% Input:
...
function [crossedPopulation,fitnessChanged] = crossoverStr1Op1(population,fitness,pCross,minSeg,maxSeg,maxAttempts)
