...
%
%% crossoverOperator2
% Function: Single point cross over operator without size restriction
% Input:
...
function [crossedIndividual1,crossedIndividual2,flag] = crossoverOperator2(individual1,individual2)
