...
%
%% initialisePopulation2
% Function: Initialisation with a predefined number of segments
% 
% Input:
...
function [newPopulation] = initialisePopulation2(nPobl,sizeChromosome,numSeg)
    newPopulation = false(nPobl,sizeChromosome);
    for i=1:nPobl,
        ind=noRepetitionRand(2,sizeChromosome-1,numSeg-1);
        newPopulation(i,ind)=1;
    end
end
