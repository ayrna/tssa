...
%           Operator2: Single point cross over operator without size restriction
% Input:
...
function [crossedPopulation,fitnessChanged] = crossoverStr2Op2(population,fitness,pCross,maxAttempts)
