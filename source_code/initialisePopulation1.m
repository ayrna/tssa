...
%
%% initialisePopulation1
% Function: Initialisation between a minSeg and maxSeg
% 
% Input:
...
function [newPopulation] = initialisePopulation1(nPobl,sizeChromosome,minSeg,maxSeg)
