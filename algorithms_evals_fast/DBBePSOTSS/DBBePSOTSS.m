 classdef DBBePSOTSS < handle
    ...
    properties
        name_parameters = {'numIt','nPobl','numSeg','seed','sizeChromosome','sizeChromosomeInt','percentage_hybridation'}
        dataFile
        data
        parameters
    end
    ...
    methods
        ...
        function [information] = runAlgorithm(obj, serie)
            ...
            while numberEvaluations < obj.parameters.numIt,
                %'PSO'
                factor = ((0.9 * (obj.parameters.numIt - numberEvaluations))/(obj.parameters.numIt-initEvaluations)) + 0.1;
